...
public class AopAgentTest {
	 ...
	 * principle to the main application entry point. After the Java Virtual
	 * Machine (JVM) has initialized, each premain method will be called in the
	 * order the agents were specified, then the real application main method
	 * will be called.
	 **/
	public static void premain(String agentArgs, Instrumentation inst) {
		...
		/*
		 * ClassFileTransformer : An agent provides an implementation of this
		 * interface in order to transform class files.
		 */
